...
export class Route1Component implements OnInit {
  ...
  addItems(count: int) {
    for (var i :int = 0; i < count; i++) {
      ...
      this.records.push({
        id: suffix, column2: this._lipsum.singleWord(), column3: this._lipsum.singleWord(), column4: this._lipsum.singleWord(), column5: this._lipsum.singleWord(),
        column6: money, column7: this._lipsum.singleWord(), column8: date, column9: this._lipsum.singleWord()
      });
    }
  }
